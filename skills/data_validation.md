...
1. **Volume Check**:
   ...
   - Strategy-specific: `swing_trading.json` requires > 150,000, `hybrid_trading.json` requires > 100,000.
2. **Price Sanity**:
...
4. **Market Cap**:
   ...
   - Strategy-specific: `swing_trading.json` uses > 1000 Cr, `hybrid_trading.json` uses > 500 Cr.
