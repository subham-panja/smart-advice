...
class Stochastic_Overbought_Oversold(BaseStrategy):
    ...
    def _execute_strategy_logic(self, data: pd.DataFrame, symbol: str = "UNKNOWN") -> int:
        ...
        try:
            ...
            if (
                prev_k <= prev_d and current_k > current_d and current_k < self.oversold_level + 10
            ):  # Within oversold recovery zone
            ...
            # Check for bearish signal - %K crosses below %D from overbought
                ...
                prev_k >= prev_d and current_k < current_d and current_k > self.overbought_level - 10
            ):  # Within overbought zone
