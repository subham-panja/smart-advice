...
class Stochastic_K_D_Crossover(BaseStrategy):
    ...
    def _execute_strategy_logic(self, data: pd.DataFrame, symbol: str = "UNKNOWN") -> int:
        ...
        try:
            ...
            if (
                previous_k <= previous_d and current_k > current_d and current_k < self.oversold_level + 10
            ):  # Within 10 points of oversold
            ...
            elif previous_k <= previous_d and current_k > current_d and current_k < self.oversold_level:
            ...
            # Sell signal: %K crosses below %D in overbought region
                ...
                previous_k >= previous_d and current_k < current_d and current_k > self.overbought_level - 10
            ):  # Within 10 points of overbought
            ...
            elif previous_k >= previous_d and current_k < current_d and current_k > self.overbought_level:
